...
Report a possible violation privately to a project maintainer using the email
address published on the
[maintainer's GitHub profile](https://github.com/cnzakii). Do not open a public
issue. If a report concerns the maintainer, report the relevant GitHub-hosted
content through
[GitHub's private abuse-reporting process](https://docs.github.com/en/communities/maintaining-your-safety-on-github/reporting-abuse-or-spam).

Project maintainers take reports of violations seriously and will make every
effort to respond in a timely manner. They will investigate reports by
reviewing relevant messages and other available evidence. Maintainers will
keep investigation and enforcement actions as transparent as possible while
prioritizing safety and confidentiality. Enforcement actions are carried out
...
based on the incident's impact on the individuals involved and the community
as a whole. Depending on the severity of a violation, lower rungs may be
skipped.
...
2. **Temporarily limited activities**
   - Event: A repeated incident that previously resulted in a warning, or the
     first occurrence of a more serious violation.
   - Consequence: A private, written warning with a time-limited cooldown
     period. The cooldown may be limited to particular communication channels
...
3. **Temporary suspension**
   - Event: A pattern of repeated violations that maintainers have tried to
   ...
   - Repair: Examples include respecting the spirit of the suspension, meeting
     the specified conditions for return, and thoughtfully reintegrating with
     the community.
4. **Permanent ban**
   - Event: A pattern of repeated violations that other steps have failed to
     resolve, or a violation so serious that maintainers determine there is no
...
This enforcement ladder is a guideline. It does not limit the project
maintainers' ability to use their discretion and judgment in the best interests
of the community.
...
spaces. Examples include using an official email address, posting through an
...
Additional enforcement and community guidance is available from the
